...
class BARTSeq2seq(pl.LightningModule):
    ...
    def optimizer_step(self, epoch, batch_idx, optimizer,
        ...
        optimizer.step(closure=lambda_closure)
        optimizer.zero_grad()
    ...
    def train_dataloader(self):
        ...
        dataloader = DataLoader(train_set, batch_size=self.hparams.train_batch_size, num_workers = 4, pin_memory=True,
    ...
    def val_dataloader(self):
        ...
        return DataLoader(val_dataset, batch_size=self.hparams.eval_batch_size,num_workers = 4, pin_memory=True,
    ...
    def test_dataloader(self, chunk_id='all', saved_ids=[]):
        ...
        return DataLoader(test_dataset, batch_size=self.hparams.eval_batch_size, shuffle=False,
